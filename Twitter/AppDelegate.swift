...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if(User.currentUser != nil ) {
           ...
           var tvc =
            ...
            var nvc =
            storyboard.instantiateViewControllerWithIdentifier("mainNavigationController") as UINavigationController
    ...
    func userDidLogout() {
        var tvc =
        storyboard.instantiateViewControllerWithIdentifier("loginViewController") as UIViewController
        window?.rootViewController = tvc
    }
